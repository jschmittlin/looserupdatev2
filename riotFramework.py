...
# Data
from data import Region, Platform, ddragon, Champion, Challenges, Summoner, Queue
...
class RiotFramework(): 
    ...
    def set_region(self, new_region):
        ...
        """
        platform = Region.from_platform(new_region)
        self.region = {
            'platform': platform,
    ...
    def fetch_match(self, match_id: str, puuid: str):
        ...
        try:
            ...
            runes_db = ddragon.get_runesReforged()
            for i in range(len(team1)):
                try:
            ...
            try:
                champions_db = ddragon.get_champions()
